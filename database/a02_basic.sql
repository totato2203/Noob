...
-- 날짜형식을 우너하는 형식으로 보거나 검색할 때는 to_char(날짜, '형식')을 활용하고
-- 특히, oracle에서 지원하는 형식 format 코드가 지정(YYYY, -, /)되어 있기 때문에
-- 이외에 출력형식으로 추가가 필요하면 '"추가형식"'을 작성해야한다.
